...
/**
 * Comprehensive tests for the OrganizerProfileScreen and its components.
 * Tests verify that all UI elements are displayed correctly.
 */
...
class OrganizerProfileScreenComposeTest {
    ...
    fun infoSection_displaysNameAndDescription() {
        ...
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.NAME_TEXT)
            .assertIsDisplayed()
            .assertTextEquals(testName)
        
        // Verify description is displayed with correct text
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.DESCRIPTION_TEXT)
            .assertIsDisplayed()
    ...
    fun socialMediaSection_displaysAllSocialMediaIcons() {
        ...
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.SOCIAL_MEDIA_SECTION)
            .assertIsDisplayed()
        
        // Verify website link is displayed
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.WEBSITE_LINK).assertIsDisplayed()
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.WEBSITE_TEXT)
            .assertIsDisplayed()
    ...
    fun followSection_displaysFollowButton_notFollowing() {
        ...
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.FOLLOW_BUTTON_TEXT)
            .assertIsDisplayed()
            .assertTextEquals("FOLLOW")
        
        // Verify followers count is displayed
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.FOLLOWERS_TEXT)
            .assertIsDisplayed()
    ...
    fun tabSection_displaysAllTabs() {
        ...
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.TAB_POSTS)
            .assertIsDisplayed()
            .assertTextEquals("Posts")
        
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.TAB_UPCOMING)
            .assertIsDisplayed()
            .assertTextEquals("UPCOMING")
        
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.TAB_PAST)
            .assertIsDisplayed()
    ...
    fun organizerProfileScreen_displaysAllSections() {
        ...
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.DESCRIPTION_TEXT).assertTextEquals(testDescription)
        ...
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.FOLLOW_SECTION).assertIsDisplayed()
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.FOLLOW_BUTTON).assertIsDisplayed()
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.FOLLOW_BUTTON_TEXT).assertTextEquals("FOLLOW")
        composeTestRule.onNodeWithTag(OrganizerProfileTestTags.FOLLOWERS_TEXT)
            .assertTextEquals("join $followersCount community")
        ...
        composeTestRule.setContent {
            OnePassTheme {
                SocialMediaIcon(
                    ...
                    contentDescription = "Instagram Test"
                )
            }
        }
