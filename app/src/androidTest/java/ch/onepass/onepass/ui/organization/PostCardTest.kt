...
/** UI tests for the PostCard composable. Tests cover display, interactions, and various states. */
...
class PostCardTest {
  ...
  fun postCard_displaysOrganizationName() {
    ...
    composeTestRule.setContent {
      MaterialTheme { PostCard(post = post, organizationName = "Test Organization") }
    }
  ...
  fun postCard_displaysPostContent() {
    ...
    composeTestRule.setContent { MaterialTheme { PostCard(post = post, organizationName = "Org") } }
  ...
  fun postCard_displaysVerifiedBadge() {
    ...
    composeTestRule.setContent {
      MaterialTheme { PostCard(post = post, organizationName = "Verified Org") }
    }
  ...
  fun postCard_likeButton_callsOnLikeClick() {
    ...
    composeTestRule.setContent {
      MaterialTheme {
        PostCard(post = post, organizationName = "Org", onLikeClick = { clickCount++ })
      }
    }
  ...
  fun postCard_likeButton_showsFilledHeart_whenLiked() {
    ...
    composeTestRule.setContent {
      MaterialTheme { PostCard(post = post, organizationName = "Org", isLiked = true) }
    }
  ...
  fun postCard_likeButton_showsOutlinedHeart_whenNotLiked() {
    ...
    composeTestRule.setContent {
      MaterialTheme { PostCard(post = post, organizationName = "Org", isLiked = false) }
    }
  ...
  fun postCard_moreButton_isHidden_whenCannotDelete() {
    ...
    composeTestRule.setContent {
      MaterialTheme { PostCard(post = post, organizationName = "Org", canDelete = false) }
    }
  ...
  fun postCard_moreButton_isVisible_whenCanDelete() {
    ...
    composeTestRule.setContent {
      MaterialTheme { PostCard(post = post, organizationName = "Org", canDelete = true) }
    }
  ...
  fun postCard_handlesLongContent() {
    val longContent =
        "This is a very long post that contains many words. " +
  ...
  fun postCard_handlesLongOrganizationName() {
    ...
    composeTestRule.setContent {
      MaterialTheme { PostCard(post = post, organizationName = longOrgName) }
    }
  ...
  fun postCard_displaysAvatarWithInitial_whenNoImageUrl() {
    ...
    composeTestRule.setContent {
      MaterialTheme {
        PostCard(post = post, organizationName = "Test Org", organizationImageUrl = null)
      }
    }
  ...
  fun postCard_hasCorrectTestTag() {
    ...
    composeTestRule
        .onNodeWithTag(PostCardTestTags.getPostCardTag("unique-post-id"))
        .assertIsDisplayed()
  }
