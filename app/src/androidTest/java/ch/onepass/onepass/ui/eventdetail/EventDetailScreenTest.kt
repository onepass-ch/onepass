...
class EventDetailScreenTest {
  ...
  @Test
  fun eventDetailScreen_displaysOrganizerSection() {
    val testEvent = createTestEvent()
    val testOrganization = createTestOrganization(name = "Test Organizer")
  ...
  @Test
  fun eventDetailScreen_displaysOrganizerFollowers() {
  ...
  @Test
  fun eventDetailScreen_displaysOrganizerRating() {
