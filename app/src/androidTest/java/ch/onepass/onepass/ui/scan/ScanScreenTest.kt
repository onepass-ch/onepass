...
class ScanScreenTest {
    ...
    fun scanningFrame_accepted_showsGreenFrame() {
        val repo =
            FakeRepo().apply {
                next = Result.success(ScanDecision.Accepted(ticketId = "T-456"))
            }
        val vm = createVM(repo)
