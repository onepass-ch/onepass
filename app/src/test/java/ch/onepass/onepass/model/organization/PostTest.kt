...
/**
 * Unit tests for the Post data class and its companion object functions.
 * Tests cover model defaults, content sanitization, validation, and display formatting.
 */
class PostTest {
    ...
    fun displayTimestamp_showsJustNow_forRecentPosts() {
        ...
        val thirtySecondsAgo = Timestamp(
    ...
    fun displayTimestamp_showsHours_forPostsLessThanOneDayOld() {
        ...
        val threeHoursAgo = Timestamp(
            (System.currentTimeMillis() / 1000) - (3 * 60 * 60),
            0
        )
    ...
    fun displayTimestamp_showsDays_forPostsLessThanOneWeekOld() {
        ...
        val twoDaysAgo = Timestamp(
            (System.currentTimeMillis() / 1000) - (2 * 24 * 60 * 60),
            0
        )
