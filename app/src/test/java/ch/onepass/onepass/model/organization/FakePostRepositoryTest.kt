...
/**
 * Unit tests for [FakePostRepository].
 * Ensures the fake implementation behaves correctly for testing purposes.
 */
class FakePostRepositoryTest {
    ...
    fun createPost_returnsFailure_whenConfiguredToFail() = runTest {
        val failingRepository = FakePostRepository(shouldFail = true, failureMessage = "Creation failed")
        val post = createTestPost("post1", "org1")
