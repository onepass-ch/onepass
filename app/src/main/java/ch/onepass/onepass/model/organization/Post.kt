 ...
 *
 * Posts are short announcements or messages (max 124 characters) that organization
 * owners can share with their followers and members.
 *
...
data class Post(
     ...
     * Shows relative time if recent, otherwise shows the date.
     */
