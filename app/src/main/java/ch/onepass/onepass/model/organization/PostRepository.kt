 ...
 *
 * This repository handles CRUD operations for posts that organizations
 * create to communicate with their community.
 */
interface PostRepository {
    ...
    /**
     * Adds the current user's like to a post.
     * Does nothing if the user has already liked the post.
     *
