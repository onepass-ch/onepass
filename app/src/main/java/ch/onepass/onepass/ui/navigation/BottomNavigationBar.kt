      ...
      windowInsets = NavigationBarDefaults.windowInsets) {
        tabs.forEach { tab ->
          ...
          val contentDescription =
              when (tab.destination.route) {
                Screen.Events.route -> stringResource(R.string.bottom_nav_events_description)
                Screen.Tickets.route -> stringResource(R.string.bottom_nav_tickets_description)
                Screen.Map.route -> stringResource(R.string.bottom_nav_map_description)
                Screen.Profile.route -> stringResource(R.string.bottom_nav_profile_description)
                else -> tab.name
              }
