 ...
 *
 * Keeping all navigation definitions in one place ensures consistency
 * and makes it easier to update or extend the navigation structure.
 */
object NavigationDestinations {
     ...
     * @property isTopLevelDestination Indicates whether this screen appears as a top-level destination
     * (i.e., directly accessible from the bottom navigation bar).
     */
    sealed class Screen(
        val route: String,
        val name: String,
