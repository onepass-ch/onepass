...
fun AuthScreen(onSignedIn: () -> Unit = {}, authViewModel: AuthViewModel = AuthViewModel()) {
  ...
  Scaffold(
    modifier = Modifier
      .fillMaxSize()
      .testTag(SignInScreenTestTags.AUTH_SCREEN),
    ...
    Box(
      ...
      BlurCircle(
        modifier =
          Modifier
            .testTag(SignInScreenTestTags.BLUR_CIRCLE_TOP)
      ...
      BlurCircle(
        modifier =
          Modifier
            .testTag(SignInScreenTestTags.BLUR_CIRCLE_BOTTOM)
